...
const DEFAULT_PRIVACY_POLICY: PrivacyPolicy = {
  ...
  noFollow: false,
  canonicalUrl: "",
  metaTitle: "Privacy Policy | Disneyland Paris Tickets Guide",
  metaDescription: "Privacy Policy and Disclaimer for Disneyland Paris Tickets — how we collect, use, and protect your information.",
  ogTitle: "",
  ogDescription: "",
  ogImage: "",
};
